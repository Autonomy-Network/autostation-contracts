...
export const Select = <T,>({ options, onSelect, value, placeholder, className = '' }: SelectProps<T>) => {
  ...
  return(
    <select
      ...
      className={`cursor-pointer mt-6 px-3 py-2 bg-gradient-to-r from-autonomyAcent500 to-autonomySecondary500 hover:from-pink-400 hover:to-autonomyAcent500 shadow-inner p-2 rounded-lg border border-white ${className}`}
    >
